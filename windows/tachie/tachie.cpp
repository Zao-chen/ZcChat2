...
Tachie::Tachie(QWidget *parent) : QWidget(parent), ui(new Ui::Tachie) {
  /*窗口设置*/
  ui->setupUi(this);
  // 无边框
  ...
  // 延迟加载立绘
  QTimer::singleShot(0, this, [this]() { SetTachieImg("default"); });
}

Tachie::~Tachie() { delete ui; }
...
// 重置立绘位置
void Tachie::ResetTachieLoc() { this->move(0, 0); }
